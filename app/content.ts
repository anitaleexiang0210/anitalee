...
export const aiProjects = [
  {
    ...
    summary:
      "把个人经历、目标方向和真实岗位要求放在一起，分清已经拥有、可以迁移、需要补齐和无法绕过的职业拼图，最后生成一份具体的 30 天行动计划。当前正在完成产品流程、隐私方案与首版原型。",
    proof: ["已有拼图", "可迁移拼图", "待补拼图", "30 天行动计划"],
    imageAlt: "NextPiece 正在进行产品定义与首版设计",
    href: "/career",
    linkLabel: "查看新品预告",
  },
  {
